...
shichoson_geo <- read_sf("materials/shared/shichoson/2019_isna/2019_summary_isna.shp")
point <-read_sf("materials/2026-articles/0112_ontake/ontake_point.geojson")
...
```{r}
# GPX のトラックポイントを読み込む
track_points <- read_sf("materials/2026-articles/0112_ontake/Ontake.gpx",
                        layer = "track_points")
